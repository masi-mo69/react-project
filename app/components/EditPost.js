...
import { useParams, Link, useNavigate } from "react-router-dom"; // تغییر از withRouter به useNavigate
...
function EditPost() {
    ...
    const navigate = useNavigate(); // برای جایگزینی props.history
